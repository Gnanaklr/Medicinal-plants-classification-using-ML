...
def upload():
    if request.method == 'POST':
        ...
        result = result.title()
        d = {"Asthma Plant":" →  Euphorbia hirta is a pantropical weed, originating from the tropical regions of the Americas. It is a hairy herb that grows in open grasslands, roadsides and pathways. It is widely used in traditional herbal medicine across many cultures, particularly for asthma, skin ailments, and hypertension.:                                                                                                                                                                                                      98",
	...
	'Indian Sarsaparilla':" → Hemidesmus indicus, Indian sarsaparilla is a species of plant found in South Asia. It occurs over the greater part of India, from the upper Gangetic plain eastwards to Assam and in some places in central, western and South India. The root is a substitute for sarsaparilla.",
        ...
        "Tulsi":" → Tulsi has also been shown to counter metabolic stress through normalization of blood glucose, blood pressure and lipid levels, and psychological stress through positive effects on memory and cognitive function and through its anxiolytic and anti-depressant properties. definite : 98"}
